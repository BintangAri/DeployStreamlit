import requests
import DeployStreamlit.streamlit as st
...
def main():
    ...
    if data:
        ...
        aqi = data["Data"]["AQI"]
        # Set daily average AQI to a fixed value of 75
        daily_avg_aqi = 75
        ...
        fig_aqi.update_layout(updatemenus=[])
        ...
        fig_humidity.update_layout(updatemenus=[])
        ...
        fig_temperature.update_layout(updatemenus=[])
        ...
        # Display daily average AQI
        st.subheader("Daily Average AQI")
        st.write(f"The average AQI for today is: {daily_avg_aqi:.2f}")
